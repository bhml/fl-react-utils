...
var Input = (function (_React$Component) {
  ...
  Input.prototype.render = function render() {
    ...
    var defaultHelp = _props.defaultHelp;
    ...
    if (_lodash2['default'].isUndefined(help)) {
      help = _validation.validationHelp(meta) || defaultHelp;
    }

    var id = _inflection2['default'].dasherize(input.name.toLowerCase());
    ...
    switch (type) {
      ...
      case 'datetime':
      case 'time':
        var placeholder = 'DD/MM/YYYY 9:00 am';
        inputProps.dateFormat = this.props.dateFormat || _moment2['default'].localeData().longDateFormat(this.props.localeDateFormat);
        if (type === 'date') {
          placeholder = inputProps.dateFormat;
          inputProps.timeFormat = false;
          if (!meta.dirty && _lodash2['default'].isString(inputProps.value)) inputProps.value = _moment2['default'](inputProps.value);
        } else if (type === 'time') {
          placeholder = '9:00 am';
        ...
        control = _react2['default'].createElement(_reactDatetime2['default'], _extends({ closeOnSelect: true, inputProps: { placeholder: placeholder } }, _lodash2['default'].omit(inputProps, 'onFocus')));
        break;
    ...
    return _react2['default'].createElement(
      ...
      { controlId: id, validationState: validationState ? validationState(meta) : null },
  ...
  _createClass(Input, null, [{
    ...
    value: {
      ...
      defaultHelp: _react.PropTypes.node,
      ...
      validationState: _react.PropTypes.func,
      feedback: _react.PropTypes.bool,
      dateFormat: _react.PropTypes.string,
      localeDateFormat: _react.PropTypes.string
    },
    enumerable: true
  }, {
    key: 'defaultProps',
    value: {
      validationState: _validation.validationState,
      localeDateFormat: 'L',
      feedback: false,
      type: 'text',
      quillTheme: 'snow',
      quillFormat: ['bold', 'italic', 'strike', 'underline', 'font', 'size', 'bullet', 'list', 'link', 'align']
    },
    enumerable: true
  }]);
